...
if menu_id == "Guidance":
  ...
  st.markdown("""Please refer to the sidebar to inspect more the inter-relation existing between the factors""")
  ...
  with st.sidebar:
    spend_choice=st.slider(
      "Money Spent", min_value=0, max_value=650, step=5, value=100)
